...
export const SITE_IMAGE_SLOTS: SiteImageSlot[] = [
  ...
  { key: 'avatar-showtime', label: 'Depoimento — SHOWTIME Eventos', fallbackSrc: '/images/avatar-showtime.png' },
  { key: 'avatar-dominique', label: 'Depoimento — Clínica Dominique', fallbackSrc: '/images/avatar-dominique.png' },
  { key: 'avatar-diego', label: 'Depoimento — Diego Wantowsky', fallbackSrc: '/images/avatar-diego.png' },
  { key: 'avatar-mundo-eletronicos', label: 'Depoimento — Mundo dos Eletrônicos', fallbackSrc: '/images/avatar-mundo-eletronicos.png' },
